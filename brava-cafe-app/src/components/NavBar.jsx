const TABS = [
  ...
  { id: 'inventario', label: 'Inventario', disabled: false },
  { id: 'finanzas', label: 'Finanzas', disabled: false },
]
    ...
    <header className="border-b border-brava-blush bg-brava-cream sticky top-0 z-10">
      <div className="max-w-5xl mx-auto px-5 pt-5 pb-3">
        <div className="flex items-baseline justify-between mb-4">
          ...
          <button
            onClick={onLogout}
            className="text-xs text-brava-reddark/50 hover:text-brava-reddark underline"
          >
            Cerrar sesión
          </button>
        </div>
